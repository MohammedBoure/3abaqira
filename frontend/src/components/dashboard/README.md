...
- **`MetricGrid.jsx`**: High-density KPI grid container housing operational counters for enrolled students, live drawer liquidity, collection rate, and cafeteria logistics.
