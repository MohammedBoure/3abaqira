...
import { User, Phone, BookOpen, CreditCard, ShieldAlert, CheckCircle2 } from 'lucide-react';
...
export function StudentRegistrationModal({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      {/* Step Tabs */}
      <div className="flex items-center gap-2 p-1 rounded-xl bg-blue-950/60 border border-blue-500/25 mb-5">
        <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full h-10 px-3.5 text-xs rounded-xl glass-input text-white"
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-blue-200 mb-1">
              ...
              <input
                ...
                className="w-full h-10 px-3.5 text-xs rounded-xl glass-input text-white font-latin"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full h-10 px-3.5 text-xs rounded-xl glass-input text-white font-mono"
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-blue-200 mb-1">
              ...
              <select className="w-full h-10 px-3.5 text-xs rounded-xl glass-input text-white">
      ...
      {activeTab === 'PLAN' && (
        <div className="space-y-4">
          ...
          <div className="p-3.5 rounded-xl bg-blue-900/30 border border-blue-400/25 flex items-center justify-between text-xs font-medium text-blue-200">
      ...
      <div className="space-y-4 text-xs">
        <div className="grid grid-cols-3 gap-3 text-center">
          <div className="p-3 rounded-xl bg-blue-950/50 border border-blue-400/20">
            <span className="text-slate-400 block mb-1">الرصيد الافتتاحي</span>
            <span className="font-mono font-bold text-sm text-white">25,000 دج</span>
          </div>
          <div className="p-3 rounded-xl bg-emerald-950/30 border border-emerald-500/30">
            <span className="text-emerald-300 block mb-1">إجمالي المداخيل</span>
            <span className="font-mono font-bold text-sm text-emerald-400">+121,200 دج</span>
          </div>
          <div className="p-3 rounded-xl bg-rose-950/30 border border-rose-500/30">
            <span className="text-rose-300 block mb-1">إجمالي المصاريف</span>
            <span className="font-mono font-bold text-sm text-rose-400">-3,700 دج</span>
          </div>
        </div>

        <div className="p-4 rounded-xl bg-blue-900/25 border border-blue-400/30 flex items-center justify-between">
          <div>
            <div className="font-bold text-white text-sm">الرصيد النظري الإجمالي:</div>
            <div className="text-[11px] text-blue-300/80">المطابق مع مجموع الأوصال المحصلة</div>
          </div>
