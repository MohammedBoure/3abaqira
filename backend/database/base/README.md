...
| [connection.py](file:///C:/Users/moham/Desktop/3abaqira/backend/database/base/connection.py) | `ConnectionManager` handling PostgreSQL / MySQL connection pools, thread-safe context managers, and SQLAlchemy engine creation. |
...
| [schema_initializer.py](file:///C:/Users/moham/Desktop/3abaqira/backend/database/base/schema_initializer.py) | Executes table definitions, views, and indexes. Utilizes SHA256 checksum fingerprinting in `AppMetadata` to bypass redundant startup checks. |
